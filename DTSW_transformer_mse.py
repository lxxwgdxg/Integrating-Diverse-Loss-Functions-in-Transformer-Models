...
# Manual split of the data into training and testing sets (80% training, 20% testing)
split_index = int((17898/22280) * dts_input_data.shape[0])
input_train, input_test = dts_input_data[:split_index], dts_input_data[split_index:]
target_train, target_test = dts_target_data[:split_index], dts_target_data[split_index:]
